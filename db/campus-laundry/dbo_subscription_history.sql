...
CREATE TABLE `subscription_history` (
  ...
  CONSTRAINT `subscription_history_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
  CONSTRAINT `subscription_history_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`),
  CONSTRAINT `subscription_history_ibfk_3` FOREIGN KEY (`subscribed_id`) REFERENCES `subscribed_customer` (`subscribed_id`)
